          ...
          return (
            ...
            >
              <div className="flex flex-col min-w-0">
                ...
                {isInterrupted ? (
                  <span className="text-[10px] text-amber-400 font-medium flex items-center gap-1.5 mt-0.5">
              ...
              <svg className={`w-3.5 h-3.5 flex-shrink-0 transition-transform ${isSelected ? (isInterrupted ? "text-amber-400 translate-x-0.5" : "text-cyan-400 translate-x-0.5") : "text-slate-650"}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
